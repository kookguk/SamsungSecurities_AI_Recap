...
.recap-hero h1 { font-size:30px; margin-top:12px; }.ai-badge { display:inline-flex; background:rgba(255,255,255,.7); color:#2b72c5; border-radius:999px; padding:7px 10px; font-size:10px; font-weight:800; margin-top:17px; }
